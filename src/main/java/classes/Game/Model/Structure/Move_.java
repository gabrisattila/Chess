...
public class Move_ {
    ...
    public Move_(IPiece what, Location from, Location to){
        this.what = what;
        this.from = from;
        this.to = to;
        hit = null;
    ...
    public Move_(IPiece what, Location from, Location to, IPiece hit){
        this.what = what;
        this.from = from;
        this.to = to;
        this.hit = hit;
    ...
    public Move_(IPiece what, Location from, Location to, String emPassantCastlePawnGotIn){
        this.what = what;
        this.from = from;
        this.to = to;
        hit = null;
    ...
    public Move_(IBoard boardToMoveOn){
        this.boardToMoveOn = boardToMoveOn;
        emPassant = false;
        castle = false;
    }

    public Move_(IBoard boardToMoveOn, IPiece what, Location from, Location to, IPiece hit){
        this.boardToMoveOn = boardToMoveOn;
        this.what = what;
        this.from = from;
        this.to = to;
    ...
    public Move_(IBoard boardToMoveOn, IPiece what, Location from, Location to, String emPassantCastlePawnGotIn){
        this.boardToMoveOn = boardToMoveOn;
        this.what = what;
        this.from = from;
        this.to = to;
    ...
    public Move_(IBoard boardToMoveOn, IPiece what, Location from, Location to, IPiece hit, String emPassantCastlePawnGotIn){
        this.boardToMoveOn = boardToMoveOn;
        this.what = what;
        this.from = from;
        this.to = to;
    ...
    //region Move_ reBrained

    //TODO Egy adott Move_ objektum tartalmazza:
    // - Mivel
    // - Honnan
    // - Hová
    ...
    public static void MOVE(IBoard board, IPiece what, Location to, boolean itsAiPawnGotIn) throws ChessGameException {
        ...
        Move_ move = new Move_(board);
        if (what.getType() == K || what.getType() == B){
            emPassantChance = "-";
            for (Move_ m : (board instanceof ViewBoard ? ((Piece) getBoard().getPiece(what.getLocation())) : ((Piece) what)).getLegalMoves() ) {
            ...
            emPassantChance = ((Move_)((Piece) what).getLegalMoves().toArray()[0]).getEmPassantCastlePawnGotIn();
            ...
            ((Move_)((Piece) what).getLegalMoves().toArray()[0]).realMove(exceptionHelper);
            return;
        }else {
            emPassantChance = "-";
    ...
    public static void MOVE(IBoard board, Move_ move, boolean itsAiPawnGotIn) throws ChessGameException {
    ...
    public static void pawnGotInCaseBackground(IPiece what, IField from, IField to, IBoard board, PieceType newType) throws ChessGameException {
        ...
        if (to instanceof ViewField){
            ((Piece) getBoard().getPiece(what.getLocation())).getLegalMoves().add(new Move_(
                    board,
            ...
            ((Piece) what).getLegalMoves().add(new Move_(
                    board,
